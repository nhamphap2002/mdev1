...
class Amasty_Shopby_Helper_Layer_View_Strategy_Attribute extends Amasty_Shopby_Helper_Layer_View_Strategy_Modeled
{
    ...
    protected function setTemplate()
    {
        ...
        $isSwathesProDisplayType = is_object($this->model) &&
            $displayType == Amasty_Shopby_Model_Source_Attribute::DT_COLOR_SWATCHES_PRO;

        $isSwatchesDisplayType = is_object($this->model) &&
            $displayType == Amasty_Shopby_Model_Source_Attribute::DT_MAGENTO_SWATCHES;
        ...
        } elseif ($isSwathesProDisplayType) {
